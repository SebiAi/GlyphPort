...
class DefaultPhone1ToPhone2LightDataTransformerParameterizedCanHandleTest(
    val invalidPhoneModelPair: Pair<PhoneModel, PhoneModel>,
    val expected: Boolean
) {
    companion object {
        private val validPhoneModelPair = PhoneModel.PHONE1 to PhoneModel.PHONE2
    ...
    // internal state
    private val transformer = DefaultPhone1ToPhone2LightDataTransformer()
